...
The acf plot of the logged series has a very slow decay, indicating that the series is not stationary, even with the transformation.

```{r, include=T,echo=T,warning=F,fig.height=3.75,fig.fullwidth=T,fig.align="center"}

acf((log(stock.BTC)), na.action = na.pass)
