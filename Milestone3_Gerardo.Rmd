...
eth <- ggplot(data=df_eth,aes(x=adjusted)) + geom_histogram() + ggtitle('Ethereum\nDistribution of Adjusted Price')

nvd <- ggplot(data=df_nvd,aes(x=adjusted)) + geom_histogram() + ggtitle('NVIDIA\nDistribution of Adjusted Price')
...
eth <- ggplot(data=df_eth,aes(x=log(adjusted))) + geom_histogram() + ggtitle('Ethereum\nDistribution of Adjusted Price')

nvd <- ggplot(data=df_nvd,aes(x=log(adjusted))) + geom_histogram() + ggtitle('NVIDIA\nDistribution of Adjusted Price')
...
cowplot::plot_grid(
 autoplot(df_eth)+ggtitle('Ethereum'),autoplot(df_nvd)+ggtitle('NVIDIA') 
)
...
cowplot::plot_grid(
 autoplot(log(df_eth))+ggtitle('Ethereum'),autoplot(log(df_nvd))+ggtitle('NVIDIA') 
)
